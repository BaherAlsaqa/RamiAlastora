...
import com.ramyhd.ramialastora.adapters.MyFavoritesTeamsPaginationAdapter;
import com.ramyhd.ramialastora.classes.responses.BodyData;
import com.ramyhd.ramialastora.classes.responses.DataPaginate;
import com.ramyhd.ramialastora.classes.responses.objects.Favorite;
...
//                Toast.makeText(getContext(), item.getName(), Toast.LENGTH_SHORT).show();
        ...
        swiperefresh.setOnRefreshListener(this::loadFirstPage);
    ...
    private void loadFirstPage() {
        ...
        callTopRatedMoviesApi().enqueue(new Callback<BodyData>() {
            ...
            @Override
            public void onFailure(@NotNull Call<BodyData> call, @NotNull Throwable t) {
    ...
    public void loadNextPage() {
        ...
        callTopRatedMoviesApi().enqueue(new Callback<BodyData>() {
            ...
            public void onFailure(@NotNull Call<BodyData> call, @NotNull Throwable t) {
                ...
                try {
                    if (getContext() != null) {
                        Log.d(Constants.Log, Objects.requireNonNull(t.getMessage()));
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
