...
import com.ramyhd.ramialastora.adapters.MyMatchesPaginationAdapter;
import com.ramyhd.ramialastora.admob.MobileAdsInterface;
import com.ramyhd.ramialastora.classes.responses.matches.BodyData;
import com.ramyhd.ramialastora.classes.responses.matches.Data;
import com.ramyhd.ramialastora.classes.responses.matches.MatchData;
import com.ramyhd.ramialastora.interfaces.Constants;
import com.ramyhd.ramialastora.listeners.OnItemClickListener5;
...
public class TomorrowMatches extends Fragment {
    private View view;
    ...
    public TomorrowMatches() {
        // Required empty public constructor
    }

    public TomorrowMatches newInstance(String param1) {
        TomorrowMatches fragment = new TomorrowMatches();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_tomorrow_matches, container, false);
        ...
        InterstitialAd interstitialAd =
                MobileAdsInterface.interstitialAds(getContext(), 1, getString(R.string.fragment_tomorrow_matches_inter));
    ...
    private Call<BodyData> callTopRatedMoviesApi() {
        ...
        Log.d(Constants.Log + "posTab", "TomorrowDate = " + matchesDate);
        if (getContext() != null) {
