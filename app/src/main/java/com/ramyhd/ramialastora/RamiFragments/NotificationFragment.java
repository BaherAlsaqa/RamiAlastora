...
import com.ramyhd.ramialastora.adapters.MyNotificationPaginationAdapter;
import com.ramyhd.ramialastora.admob.MobileAdsInterface;
import com.ramyhd.ramialastora.classes.responses.notifications.Data;
import com.ramyhd.ramialastora.classes.responses.notifications.NotificationBody;
import com.ramyhd.ramialastora.classes.responses.notifications.NotificationData;
import com.ramyhd.ramialastora.interfaces.Constants;
import com.ramyhd.ramialastora.listeners.OnItemClickListener8;
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        ...
        if (BACK_FRAGMENTS > 0) {
            try {
                ...
                e.printStackTrace();
                ((FromNotification) getActivity()).menuBackIcon(R.menu.toolbar_back, R.string.menu_notification, "", 0);
            }
            BACK_FRAGMENTS = 0;
        }
    }
